// Soft 3D companion assets are generated once and shipped locally. Keeping the
// decorative overlays in markup lets interactions stay lively without swapping
// the character image or downloading a sprite sheet.
...
export function renderPetArt(petType, accessoryId = 'none') {
  ...
  return `<img class="pet-art pet-art--${type}" src="./assets/pets/${type}-3d.png" width="384" height="576" alt="" aria-hidden="true" decoding="async" draggable="false">
